...
export default function Lamps() {
  ...
  const loadProducts = () => {
    ...
    const allProducts = getCategoryProducts('lamps').filter(p => !removed.includes(p.id))
      ...
      <div className="min-h-screen pt-20 bg-light-gray">
        <div className="bg-gradient-to-r from-primary-orange to-hover-orange py-16 mb-12">
          <div className="container mx-auto px-4 text-center">
            <i className="fas fa-lightbulb text-6xl text-white mb-4"></i>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Lamps & Lighting</h1>
            <p className="text-xl text-white/90">Illuminate your space with unique 3D printed lamps</p>
          </div>
        </div>
