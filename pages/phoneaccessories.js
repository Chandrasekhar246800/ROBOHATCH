...
export default function PhoneAccessories() {
  ...
  const loadProducts = () => {
    ...
    const allProducts = getCategoryProducts('phoneaccessories').filter(p => !removed.includes(p.id))
      ...
      <div className="min-h-screen pt-20 bg-light-gray">
        <div className="bg-gradient-to-r from-primary-orange to-hover-orange py-16 mb-12">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Phone Accessories</h1>
            <p className="text-xl text-white/90">Must-have mobile accessories for your smartphone</p>
          </div>
        </div>
