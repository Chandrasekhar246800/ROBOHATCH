      ...
      <div className="min-h-screen pt-20 bg-light-gray">
        <div className="bg-gradient-to-r from-primary-orange to-hover-orange py-16 mb-12">
          <div className="container mx-auto px-4 text-center">
            <i className="fas fa-om text-6xl text-white mb-4"></i>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Religious Idols</h1>
            <p className="text-xl text-white/90">Divine idols crafted with precision and devotion</p>
          </div>
        </div>
