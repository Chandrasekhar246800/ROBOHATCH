export default function Hero() {
  ...
  return (
    <section className="py-20 pb-15 bg-gradient-to-br from-white via-[#fff5f0] to-[#ffe8dc] min-h-0 flex items-center" id="home">
      <div className="max-w-[1200px] mx-auto px-5 flex flex-col gap-12">
        {/* Animated ROBOHATCH with rotating lights */}
        <div className="relative w-full h-[280px] flex items-center justify-center mb-6">
          <div className="absolute w-[700px] h-[700px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 [perspective:1000px]">
            <div className="absolute w-full h-full rounded-full border-[5px] border-transparent animate-rotate-arc [transform-style:preserve-3d] border-t-[#F25C05] border-r-[rgba(242,92,5,0.5)] [animation-duration:3s] [filter:drop-shadow(0_0_30px_#F25C05)_drop-shadow(0_0_60px_rgba(242,92,5,0.8))]"></div>
            <div className="absolute w-full h-full rounded-full border-[5px] border-transparent animate-rotate-arc [transform-style:preserve-3d] border-t-[#F27405] border-r-[rgba(242,116,5,0.5)] [animation-duration:2.5s] [animation-direction:reverse] [transform:rotateY(60deg)] [filter:drop-shadow(0_0_25px_#F27405)_drop-shadow(0_0_50px_rgba(242,116,5,0.7))]"></div>
            <div className="absolute w-full h-full rounded-full border-[5px] border-transparent animate-rotate-arc [transform-style:preserve-3d] border-t-[#F2935C] border-r-[rgba(242,147,92,0.5)] [animation-duration:3.5s] [transform:rotateY(-60deg)] [filter:drop-shadow(0_0_35px_#F2935C)_drop-shadow(0_0_70px_rgba(242,147,92,0.6))]"></div>
             <div className="absolute w-full h-full rounded-full border-[5px] border-transparent animate-rotate-arc [transform-style:preserve-3d] border-t-[#F25C05] border-r-[rgba(242,92,5,0.5)] [animation-duration:3s] [filter:drop-shadow(0_0_30px_#F25C05)_drop-shadow(0_0_60px_rgba(242,92,5,0.8))]"></div>
            <div className="absolute w-full h-full rounded-full border-[5px] border-transparent animate-rotate-arc [transform-style:preserve-3d] border-t-[#F27405] border-r-[rgba(242,116,5,0.5)] [animation-duration:2.5s] [animation-direction:reverse] [transform:rotateY(60deg)] [filter:drop-shadow(0_0_25px_#F27405)_drop-shadow(0_0_50px_rgba(242,116,5,0.7))]"></div>
            <div className="absolute w-full h-full rounded-full border-[5px] border-transparent animate-rotate-arc [transform-style:preserve-3d] border-t-[#F2935C] border-r-[rgba(242,147,92,0.5)] [animation-duration:3.5s] [transform:rotateY(-60deg)] [filter:drop-shadow(0_0_35px_#F2935C)_drop-shadow(0_0_70px_rgba(242,147,92,0.6))]"></div>
          </div>
          
          <h1 className="text-[5rem] font-black tracking-[0.3rem] text-black relative z-10 animate-title-glow flex gap-1 justify-center [text-shadow:0_4px_10px_rgba(0,0,0,0.2)]">
