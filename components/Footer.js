...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-brown text-white py-10 sm:py-16 md:py-20 lg:py-24">
      <div className="max-w-[1400px] mx-auto px-5 sm:px-5 lg:px-6 xl:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-8 lg:gap-10 xl:gap-12 mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          <div className="space-y-3 sm:space-y-4 md:space-y-5">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <Image src="/logo.png" alt="ROBOHATCH Logo" width={35} height={35} className="sm:w-[40px] sm:h-[40px] md:w-[45px] md:h-[45px]" />
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-orange">ROBOHATCH</h3>
            </div>
            <p className="text-gray-300 text-xs sm:text-sm md:text-base leading-relaxed">Bringing your ideas to life through innovative 3D printing technology.</p>
          ...
          <div className="space-y-3 sm:space-y-4">
            <h4 className="text-base sm:text-lg md:text-xl font-bold mb-3 sm:mb-4">Quick Links</h4>
          ...
          <div className="space-y-3 sm:space-y-4">
            <h4 className="text-base sm:text-lg md:text-xl font-bold mb-3 sm:mb-4">Support</h4>
            <ul className="space-y-2 sm:space-y-3">
          ...
          <div className="space-y-3 sm:space-y-4">
            <h4 className="text-base sm:text-lg md:text-xl font-bold mb-3 sm:mb-4">Newsletter</h4>
