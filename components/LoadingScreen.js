...
export default function LoadingScreen() {
  ...
  return (
    <div className={`fixed inset-0 bg-black flex items-center justify-center z-[9999] ${isComplete ? 'opacity-0 transition-opacity duration-500' : 'opacity-100'}`}>
      <div className="relative flex flex-col items-center">
        ...
        {/* Company Name */}
        <h1 className="text-6xl font-bold text-white mb-8 tracking-[0.3em] animate-pulse">
          ROBOHATCH
        </h1>
